 ...
 * \param [in] inscalar_SimpleKernel_x0 Input scalar parameter "SimpleKernel.x0".
 * \param [out] outstream_x1 The stream should be of size (param_N * 8) bytes.
 */
void Simple(
	int32_t param_N,
	double inscalar_SimpleKernel_x0,
	double *outstream_x1);
...
typedef struct { 
	...
	double inscalar_SimpleKernel_x0; /**<  [in] Input scalar parameter "SimpleKernel.x0". */
	double *outstream_x1; /**<  [out] The stream should be of size (param_N * 8) bytes. */
} Simple_actions_t;
